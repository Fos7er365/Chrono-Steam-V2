...
Shader "Fresnel_v2"
{
	Properties
	{
		_FresnelRimPower("Fresnel Rim Power", Range( 0 , 10)) = 0
		[HDR]_FresnelColor("Fresnel Color", Color) = (1,0.2206753,0,0)
	...
	SubShader
	{
		...
		uniform float _FresnelRimPower;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fresnelNode1 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV1, (10.0 + (_FresnelRimPower - 0.0) * (0.0 - 10.0) / (10.0 - 0.0)) ) );
			float4 temp_output_6_0 = ( _FresnelColor * fresnelNode1 );
			o.Albedo = temp_output_6_0.rgb;
			o.Emission = temp_output_6_0.rgb;
			o.Alpha = ( fresnelNode1 * _FresnelSize );
		}
